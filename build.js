...
${links}    </nav>
    <div class="head-cta">
      ...
      <button class="nav-toggle" type="button" aria-label="Open navigation menu" aria-controls="mobile-nav" aria-expanded="false">
...
<div id="mobile-nav" class="mobile-nav" aria-hidden="true">
  <div class="mobile-nav-scrim" tabindex="-1"></div>
  <nav class="mobile-nav-drawer" aria-label="Mobile Navigation">
    <div class="mobile-nav-head">
      <div class="mobile-nav-brand">
        <img src="assets/img/logo.png" alt="Pathways Mapping Nigeria Limited logo" width="38" height="38">
        <div class="mobile-nav-brand-text">
          <span class="mobile-nav-title">Pathways Mapping</span>
          <span class="mobile-nav-sub">Nigeria Limited</span>
        </div>
      </div>
      <button type="button" class="mobile-nav-close" aria-label="Close navigation menu">&times;</button>
    </div>
    <div class="mobile-nav-links">
${NAV.map(([href, label]) => `      <a href="${href}"${href === active ? ' class="is-active" aria-current="page"' : ''}><span>${label}</span><svg class="mobile-nav-arr" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M9 18l6-6-6-6"/></svg></a>\n`).join('')}    </div>
    <div class="mobile-nav-foot">
      <a href="contact.html#quote" class="btn btn--primary btn--block">Request a Quote</a>
      <div class="mobile-nav-quick">
        <a href="tel:${PHONE_E164}" class="mobile-nav-quick-btn mobile-nav-call">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.02-.24 11.4 11.4 0 003.58.57 1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1 11.4 11.4 0 00.57 3.58 1 1 0 01-.24 1.02l-2.21 2.19z"/></svg>
          <span>Call Us</span>
        </a>
        <a href="https://wa.me/2348165329943" class="mobile-nav-quick-btn mobile-nav-wa" target="_blank" rel="noopener">
      ...
      <div class="mobile-nav-badges">
        <span>CAC Incorporated</span> &bull; <span>SURCON Regulated</span> &bull; <span>NIS Member</span>
      </div>
    </div>
  </nav>
</div>
